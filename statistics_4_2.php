									...
									<?php
											...
											while($row1=mysqli_fetch_assoc($count1)){
												...
												while($row=mysqli_fetch_assoc($ret)){
													...
													"<tr>
														<td align='center'>
														<a href='statistics_4_3.php?seme=$_GET[seme] & con=$_GET[con] & stu=$_GET[stu] & grade=$row[stu_grade]'>
														$row[stu_grade] 年級
														</a>
														</td>
