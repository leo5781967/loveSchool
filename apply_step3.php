			...
			<div class="w3-padding-64 w3-content w3-text-grey" id="contact1"  style="max-width: 500px;">
				<?php
					...
					"<form name='form_name' id='form_name'>
						<input type='radio' name='check_radio' id='check_radio1' value='0'><label  style='color: #fff;cursor: pointer;' for='check_radio1'> 期限過後仍可做審核</label>
						&nbsp;&nbsp;&emsp;
						<input type='radio' name='check_radio' id='check_radio2' value='1' checked><label  style='color: #fff;cursor: pointer;' for='check_radio2'> 期限過後不可做審核</label>
					</form><br>";
					//------------------
					/*--指定單位--*/
