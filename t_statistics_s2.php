				...
				<div class="w3-padding-64 w3-content w3-text-grey" id="contact">
					<div id="page-wrapper">
						<!-- Banner -->
							<section id="banner">
								<header>
										<h2 style='color:#ffffff;'>統計各處室(科)-年級</h2>
										<h2 style='color:#ffffff;'><?php echo $_GET["seme"].$_GET["unitname"].$_GET["stu"]; ?></h2>
								</header>
									...
									<?php
											...
											$ret=mysqli_query($link,$select);
												...
												while($row=mysqli_fetch_assoc($ret)){
													...
													"<tr>
														<td align='center'>
														<a href='t_statistics_s3.php?seme=$_GET[seme] & unitname=$_GET[unitname] & stu=$_GET[stu] & grade=$row[stu_grade]'>
														$row[stu_grade]
														</a>
														</td>
