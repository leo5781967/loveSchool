				...
				<div class="w3-padding-64 w3-content w3-text-grey" id="contact">
					<div id="page-wrapper">
						<!-- Banner -->
							<section id="banner">
								<header>
										<h2 style='color:#ffffff;'>本班事由統計-其他事由-學生</h2>
										<h2 style='color:#ffffff;'><?php echo $_GET["seme"]." 其他 ".$_GET["con"]; ?></h2>
								</header>
											...
											while($row=mysqli_fetch_assoc($count1)){
												...
												while($row1=mysqli_fetch_assoc($ret1)){
													...
													"<tr>
														...
														<td align='center'>
														<a href='student_inf_1.php?seme=$_GET[seme] & con=$_GET[con] & name=$row1[stu_name]'>
														$row1[totalhr]
														</a>
														</td>
													</tr>";
