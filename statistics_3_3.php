				...
				<div class="w3-padding-64 w3-content w3-text-grey" id="contact">
					<div id="page-wrapper">
						<!-- Banner -->
							<section id="banner">
								<header>
										<h2 style='color:#4B0091;'>統計各處室(科)-班級</h2>
										<h2 style='color:#4B0091;'><?php echo $_GET["seme"].$_GET["unitname"].$_GET["stu"].$_GET["grade"]."年"; ?></h2>
								</header>
									...
									<?php
											...
											$ret=mysqli_query($link,$select);
												...
												while($row=mysqli_fetch_assoc($ret)){
													...
													"<tr>
														<td align='center'>
														<a href='statistics_3_4.php?seme=$_GET[seme] & unitname=$_GET[unitname] & stu=$_GET[stu] & grade=$_GET[grade] & class=$row[class_name]'>
														$row[class_name]
														</a>
														</td>
